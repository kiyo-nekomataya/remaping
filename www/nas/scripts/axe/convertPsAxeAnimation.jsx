...
//実際の処理
var currentFPS=nas.FRATE.rate;//現作業のfpsを取得
...
nas.FRATE.parse(nas.axeVTC.getFrameRate());
	cAm.processCount++;
//処理時間警告
var ExProcessingTime= Math.floor(myTargets.length*(4.5)*0.02);
if(ExProcessingTime>60){cAm.abortProcess=(confirm(nas.localize(cAm.uiMsg.warnTimeOver,Math.floor(ExProcessingTime/60))))?false:true;}
