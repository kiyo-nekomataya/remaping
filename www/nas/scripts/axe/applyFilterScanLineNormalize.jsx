...
applyPbk(nasLibFolderPath+"PixelBenderKernel/scanLineNormalize.pbk","scanLineNormalize",[
["saturation",(colorParams.bgc.m+colorParams.fgc.m)*2],
["backgroundClip",(colorParams.bgc.i/255.)*90.],
["lineIntensity",(colorParams.fgc.i+255)/5.12]
],mOdes);
...
*/
applyFilter("psPaint scanLineNormalize...",[
["cTl0",Math.floor((colorParams.bgc.m+colorParams.fgc.m)*2)],
["cTl1",Math.floor((colorParams.bgc.i)*.9)],
["cTl2",Math.floor((colorParams.fgc.i+255)/2)]
],"ALL");
}
  }
