/**	applyFilterTraceK.jsx
 *	@overview	線画の黒いトレース部分を残してほかを透明にします。
 *	
 */
/*
	Photoshopスクリプト
...
"traceK",
[
["saturation",(((colorParams.bgc.m)*9)+colorParams.fgc.m)/182],
...
*/
var xss=Math.floor(((colorParams.bgc.m)*2+(colorParams.fgc.m)*8)/1.40);
	if(xss<2){xss+=2;};
applyFilter("psPaint traceK...",[
	["cTl0",xss],
