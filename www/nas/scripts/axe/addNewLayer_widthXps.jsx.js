...
//現レイヤーがタイムシートと思われる場合は、新規レイヤー名を強制的に"sheet"とする
	if(currentLayer.name.match(/sheet|st|sht|xps|dope|xdts|tdts/)) newName='sheet';
...
//	"新規動画レイヤ作成";
var myUndoStr=nas.localize(nas.uiMsg["addNewLayer"]);
var myExcute="";
...
if(nas.axeVTC.getDuration()){
	myExcute+='nas.axeVTC.setDuration(nas.axe.skipFrames);';
}
