...
//=========================　ダイアログを作成
var myHeight=2.5;
w = nas.GUI.newWindow("dialog",nas.localize({en:"Framerate setting",ja:"フレームレート設定"}),6,myHeight,320,360);
//プロパティ設定	
//buttonFunction

var vOffset=0;
w.tx01=nas.GUI.addStaticText(w,"psAxe :"+nas.FRATE.rate,0,vOffset,2,1);
if(animationMode=="timelineAnimation"){
w.tx00=nas.GUI.addStaticText(w,"timeline :"+nas.axeVTC.getFrameRate(),0,.7+vOffset,2,1);

}
w.cb23=nas.GUI.addComboBox(w,[12,12.5,15,23.976,24,25,29.97,30,50,59.94,60,100],nas.FRATE.rate,3,.5+vOffset,2,1)
...
w.bt32.onClick=function(){
	nas.FRATE.parse(parseFloat(this.parent.cb23.value));
