...
//リソースが読み込まれていないので動作フラグセット
	...
	if(doRead){
//undoセット
app.beginUndoGroup("load boldTemplate");
...
//この下はデフォルト値なのでわざわざ上書きしなくともよいかかか
		myXps.trin=[0,"trin"];//
		myXps.trout=[0,"trout"];//
		myXps.create_user.parse(system.userName);//
		myXps.update_user.parse(system.userName);//
...
var boldTexts=[
	...
	["##FRAME_RATE",myXps.framerate.toString()],
	["##FPS",myXps.framerate.rate+"fps"],
	["##MEMO",myXps.getNoteText()]
];
