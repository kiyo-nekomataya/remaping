...
*/
w.okBt=nas.GUI.addButton	(w,"OK",0,targetLayers.length+addHeight-1,3,1);
w.rstBt=nas.GUI.addButton	(w,"Reset",3,targetLayers.length+addHeight-1,2,1);
w.cnlBt=nas.GUI.addButton	(w,"Cancel",5,targetLayers.length+addHeight-1,2,1);

if(boldEdit.confirm.type=="palette"){w.cnlBt.text="close"};//モードがパレットのときはキャンセルをクローズに書き換え

//---------------------------------------------------action
//			okボタン動作　現状のコントロールの値をレイヤの値と置き換えてウィンドウを閉じる
...
//			resetボタン動作　コントロールの値をレイヤから取得しなおす
