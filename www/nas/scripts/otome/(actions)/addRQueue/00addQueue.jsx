...
//現状を取得　復帰時のバックアップを兼ねる
	...
	var myTPLIndex=app.preferences.getPrefAsString("Render Settings Preference Section v6","Default RS Index");//最後の設定内容を取得 11 CS6-CC-CC2014
...
//	var myTemplateName="ドラフト設定";//きめうち指定の場合は直接名前を指定
	var myOMName=myRQitem.outputModule(1).templates[myOPMIndex];//AEの標準テンプレートを参照する場合はこれ
//	var myOMName="WIDEMPG4";//きめうち設定
//=== ファイル保存先の指定	
//	var myStoreFile=new File("E:\\pocoApoco\\render\\"+this.name);//こういう風に自前のフォルダを設定しちゃう
