...
//	nas.ToolBox.ItemList[nas.ToolBox.ItemList.length-1].btTitle="デモスクリプト";//ボタンタイトルを変更できます
...
//	nas.ToolBox.ItemList.push(["りまぴん",function(){uriOpen("http://homepage.mac.com/nekomata_ya/tools/remaping/")}]);
