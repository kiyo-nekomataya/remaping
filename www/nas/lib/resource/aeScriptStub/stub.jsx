 ...
 * @type {string}
 */
var myFilename = "stub.js";
/**
 * ファイルージョンはアバウトパネルで表示されます。
 * @type {string}
 */
var myFilerevision = "0.01";
...
var exFlag = true;
/**
 * 識別用のモジュール名で置き換えてください。
 * @type {string}
 */
var moduleName = "PaletteOrPanelStub";
/**
 * モジュール配下のメインウィンドウ名をできる限りユニークに
 * @type {string}
 */
var myWindowName = "StubWindow";
...
if (exFlag) {
     ...
     * @type {number}
     */
    var myDefaultLeft = nas.GUI.dafaultOffset[0];
    /**
     * お好きな値で置き換えてください。
     * @type {number}
     */
    var myDefaultTop = nas.GUI.dafaultOffset[1];
...
// ///////////// GUI 設定 /////////////
    ...
    if ((this) && (this instanceof Panel)) {
         ...
         * パネルの参照
         */
        nas[moduleName][myWindowName] = this;
    } else {
