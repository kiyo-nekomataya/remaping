...
/* Electron用の設定を読み出して共有
    ElectronProjectのルートフォルダが、アプリケーションの更に上層に変更されたためこの取得は不能
...
_exclusive_items_,,0
// */
config.ToolView = '000000000000000000000011111111111101000000000000000';
...
config.cookieTable ={
    "remaping"     :"remaping",
    "xpsedit"      :"remaping",
    "pman_reName"  :"pman_reName"
};//クッキーを保存するためのキーワード/共用部分の多いアプリではクッキーを共用

config.cookie["pman_reName"]={
    useCookie     : true,
    expiers       : 31,
    DocumentProp  : true,
    XPSAttrib     : true,
